								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
										  ...
										  <form id="Bshopform" action="{{route('vendor-prod-catalog-update',$data->id)}}" method="POST" enctype="multipart/form-data">
											{{csrf_field()}}
...
// Gallery Section Insert
  ...
  $(document).on('click', '#prod_gallery' ,function() {
    ...
    $('#Bshopform').find('.removegal').val(0);
  });
  ...
  $("#uploadgallery").change(function(){
     ...
     for(var i=0;i<total_file;i++)
     {
      ...
      $('#Bshopform').append('<input type="hidden" name="galval[]" id="galval'+i+'" class="removegal" value="'+i+'">')
     }
