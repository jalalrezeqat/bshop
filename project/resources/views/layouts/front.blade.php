				...
				<div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
					<nav hidden>
						...
						<ul class="menu">
							...
							@endif
							<li>
								<a href="{{ route('front.shops') }}"><i class=""></i> {{ $langg->lang900 }}</a>
							</li>
							<li>
							...
							@if (Auth::user())
							<li>
								<a href="{{ route('user-dashboard') }}"><i class="fnav-header"></i> {{ $langg->lang221 }}</a>
							</li>
							@if(Auth::user()->IsVendor())
							<li>
...
<script>
	...
	<script type="text/javascript">
		...
		s1.async=true;
		s1.src='https://embed.tawk.to/627a1a48b0d10b6f3e716f58/1g2mfdaps';
		s1.charset='UTF-8';
