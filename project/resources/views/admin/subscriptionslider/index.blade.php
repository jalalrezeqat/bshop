...
{{-- DATA TABLE --}}
    ...
    var table = $('#Bshoptable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-subscriptionslider-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('admin-subscriptionslider-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
