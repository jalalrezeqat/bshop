				...
				<div class="col-lg-12">
					<div class="product-description">
						<div class="body-area">
							...
							@else
								<form id="Bshopform" action="{{ route('admin-activate-purchase') }}" method="POST">
									{{csrf_field()}}
									...
									<div class="row">
										...
										<div class="col-lg-7">
											<input class="form-control" name="pcode" id="admin_name" placeholder="{{ __('Enter 0 Purchase Code') }}" required="" value="" type="text">
										</div>
									</div>
